...
\begin{abstract}
    ...
    El algoritmo consiste en 3 fases diferenciadas. La primera fase de generación de contrafactuales encontrados mediante la resolución de problema de optimización no lineal. La segunda fase es la generación de un espacio de cobertura en el intervalon generado por los valores objetivo en los contrafactuales. Por último se genera un modelo causal sobre el intervalo de cobertura, y se asigna una puntuación a cada contrafactual; la puntuación mide el grado de alineación del contrafactual contra las suposiciones causales que tienen los modelos de series temporales.

    El trabajo incluye la implementación del algoritmo que se ha realizado en Python, dado que el código es públicamente accesible.
