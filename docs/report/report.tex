...
Cada serie se entrena con los métodos usuales para series temporales, con un split 60, 20, 20, y se normaliza cada variable por por \textit{min-max}.
...
La Tabla~\ref{tab:res_protocolo} recoge la configuración, que constitute 216 ejecuciones de CFGTS.
...
\begin{table}[H]
    ...
    {\begin{tabular}{|p{4.1cm}|p{5.2cm}|c|}
            ...
            \hline
            Software de desarrollo             & Python, VSCode, \texttt{uv}, Git, \LaTeX{} y bibliotecas de código abierto & {,}00                    \\
            \hline
            Servicios de computación externos  & No utilizados durante el desarrollo ni la evaluación                       & {,}00                    \\
            \hline
...
% Hablar de que el método de generación de contrafactuales del paso 1 se puede cambiar por otros métodos.
