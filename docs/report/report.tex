...
Se emplean dos conjuntos de datos, resumidos en la Tabla~\ref{tab:res_datos}. El primero es un conjunto sintético de 20 series AR(2) estacionarias de longitud variable y mecanismo generador lineal, el segundo es la serie de actividad solar \textit{Sunspots} (1700-2008), no lineal y con un ciclo conocido de (aproximadamente) once años.
...
A cada conjunto de datos se ajustan dos modelos: una regresión lineal y un \textit{Random Forest}. El valor objetivo de cada instancia se define como una ventana, $y^{*}_d = \operatorname{mediana}(\mathbf{x}_{0,d}) \cdot (1 + cp)$, con $cp = 0{,}50$.

La Tabla~\ref{tab:res_protocolo} recoge la configuración, que constitute 126 ejecuciones de CFGTS.
...
\begin{table}[H]
    ...
    {\begin{tabular}{|p{6.2cm}|p{5.8cm}|}
            ...
            \hline
            Desplazamiento del objetivo $cp$        & ${,}50$                                                         \\
            \hline
...
\begin{table}[H]
    ...
    {\begin{tabular}{|p{2.9cm}|p{2.4cm}|c|c|c|c|}
            ...
            \hline
            Sintético AR(2)   & Lineal          & ${,}970 \pm 0{,}009$ & ${,}890$                & $+0{,}080$ & $\mathbf{<0{,}001}$ \\
            \hline
            Sintético AR(2)   & Random Forest   & ${,}617 \pm 0{,}046$ & ${,}506$                & $+0{,}110$ & $\mathbf{{,}005}$   \\
            \hline
            \textit{Sunspots} & Lineal          & ${,}955 \pm 0{,}015$ & ${,}923$                & $+0{,}032$ & $\mathbf{{,}04}$    \\
            \hline
            \textit{Sunspots} & Random Forest   & ${,}502 \pm 0{,}098$ & ${,}413$                & $+0{,}089$ & ${,}23$             \\
            \hline
        \end{tabular}}
\end{table}
...
\begin{table}[H]
    ...
    {\begin{tabular}{|p{2.9cm}|p{2.4cm}|c|c|c|c|}
            ...
            \hline
            Sintético AR(2)   & Lineal          & {,}994 & {,}001                  & 15{,}6         & {,}020                \\
            \hline
            Sintético AR(2)   & Random Forest   & {,}808 & {,}112                  & 12{,}3         & {,}049                \\
            \hline
            \textit{Sunspots} & Lineal          & {,}991 & {,}002                  & 13{,}9         & {,}236                \\
            \hline
            \textit{Sunspots} & Random Forest   & {,}748 & {,}134                  & 12{,}1         & {,}080                \\
            \hline
        \end{tabular}}
\end{table}
...
La experimentación con los conjuntos datos confirman la hipótesis. Con modelo lineal, $\bar{s}$ alcanza ${,}970 \pm 0{,}009$, el valor más alto y más estable de toda la evaluación.

Al sustituir el modelo por un \textit{Random Forest} la puntuación cae a ${,}617 \pm 0{,}046$. Aquí la puntuación deja de ser trivialmente alta, pero el control también desciende en paralelo, hasta ${,}506$.
...
El comportamiento de la puntuación causal apenas se distingue del observado en el conjunto sintético: ${,}955 \pm 0{,}015$ con modelo lineal y ${,}502 \pm 0{,}098$ con \textit{Random Forest}. La degradación respecto del escenario controlado es de apenas ${,}015$ puntos para el modelo lineal.

Esta insensibilidad es en sí misma el resultado: se recuerda de la Fase~3 de la propuesta que la puntuación causal no mide la fidelidad del modelo al proceso real, sino la \textit{coherencia interna} entre el contrafactual y el mecanismo que el modelo ha aprendido. Un modelo lineal de orden 3 es un mal predictor de la actividad solar (al menor peor que el Random Forest). La consecuencia práctica es que una puntuación causal elevada no debe interpretarse como evidencia de que la explicación sea válida respecto del fenómeno, sino respecto del modelo; si el modelo es una mala representación del fenómeno, la explicación será internamente coherente y a la vez extrínsecamente engañosa.
