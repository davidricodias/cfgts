...
En presencia de correlación perfecta, la matriz de diseño pierde rango y el modelo no puede estimarse de forma única. Cuando la correlación no es perfecta pero sí muy alta, la estimación sigue siendo posible, aunque los coeficientes individuales pasan a ser numéricamente inestables y su incertidumbre aumenta considerablemente. Como consecuencia, los contrastes sobre coeficientes concretos se vuelven poco fiables y también empeora la capacidad de interpretar el peso específico de cada variable explicativa. El problema se vuelve mucho más acuciante cuando se extrapola fuera del soporte histórico de las variables explicativas, pues en ese caso pequeñas inestabilidades en los coeficientes pueden traducirse en pronósticos muy poco robustos \cite{Hyndman2021}.
