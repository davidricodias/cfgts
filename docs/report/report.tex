...
La regresión de series temporales trata de predecir el valor futuro de la serie, dado un conjunto de observaciones pasadas. Por ejemplo, predecir el número de hipotecas sobre viviendas en España para el próximo año, dado el número de hipotecas en los años anteriores. La teoría estadística de la regresión de series temporales asume que la secuencia observada es una realización específica de un proceso aleatorio, donde la aleatoriedad surge de muchas interacciones independientes entre sí. En este marco, el objetivo es construir un modelo que capture las dependencias temporales y permita predecir el valor futuro de la serie con la mayor precisión posible \cite{Anderson1994}. La tarea de regresión puede ser de un único paso, donde se predice un único valor futuro, o de múltiples pasos, donde se predicen varios valores futuros de la serie.
...
\subsection{Modelos de regresión de series temporales}
